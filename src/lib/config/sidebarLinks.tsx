...
export const sidebarLinksByRole: Record<string, SidebarLink[]> = {
  ...
  FINANCE_BILLING: [
    ...
    { title: "Billing Management", href: "/billing", icon: Wallet, permission: Permission.MANAGE_BILLING },
    { title: "Invoices", href: "/billing", icon: Receipt, permission: Permission.MANAGE_BILLING },
    { title: "Payments", href: "/billing", icon: CreditCard, permission: Permission.MANAGE_BILLING },
    { title: "Revenue Analytics", href: "/billing", icon: TrendingUp, permission: Permission.VIEW_ANALYTICS },
    { title: "Financial Reports", href: "/billing", icon: DollarSign, permission: Permission.VIEW_REPORTS },
  ],
  THERAPIST: [
  ...
  SUPPORT_STAFF: [
    ...
    { title: "Help Requests", href: "/support-staff/requests", icon: ClipboardList, permission: Permission.VIEW_APPOINTMENTS },
    { title: "Billing", href: "/billing", icon: Wallet, permission: Permission.VIEW_BILLING },
  ],
  NURSE: [
