...
export enum Permission {
  ...
  VIEW_VIDEO_APPOINTMENTS = 'VIEW_VIDEO_APPOINTMENTS',
  CREATE_VIDEO_APPOINTMENTS = 'CREATE_VIDEO_APPOINTMENTS',
  UPDATE_VIDEO_APPOINTMENTS = 'UPDATE_VIDEO_APPOINTMENTS',
  DELETE_VIDEO_APPOINTMENTS = 'DELETE_VIDEO_APPOINTMENTS',
  JOIN_VIDEO_APPOINTMENTS = 'JOIN_VIDEO_APPOINTMENTS',
  END_VIDEO_APPOINTMENTS = 'END_VIDEO_APPOINTMENTS',
  VIEW_VIDEO_RECORDINGS = 'VIEW_VIDEO_RECORDINGS',
  MANAGE_VIDEO_SETTINGS = 'MANAGE_VIDEO_SETTINGS',
  ...
  MANAGE_DOCTOR_SCHEDULES = 'MANAGE_DOCTOR_SCHEDULES',
