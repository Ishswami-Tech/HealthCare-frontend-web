...
const TrustBuilding = () => {
  ...
  const guarantees = [
    { condition: 'Sciatica', guarantee: '70% pain reduction', timeframe: '14 days', measurement: 'VAS pain scale + mobility tests', successRate: 92 },
    { condition: 'Chronic Knee Pain', guarantee: 'Walking without support', timeframe: '21 days', measurement: 'Distance walked + pain scale', successRate: 95 },
    { condition: 'Frozen Shoulder', guarantee: '50% mobility increase', timeframe: '30 days', measurement: 'Range of motion measurement', successRate: 88 },
    { condition: 'Tennis Elbow', guarantee: 'Return to normal activities', timeframe: '10 days', measurement: 'Grip strength + pain assessment', successRate: 94 },
    { condition: 'Plantar Fasciitis', guarantee: 'Pain-free walking', timeframe: '15 days', measurement: 'Morning pain + walking test', successRate: 90 },
    { condition: 'Cervical Spondylosis', guarantee: '60% symptom improvement', timeframe: '20 days', measurement: 'Neck mobility + pain reduction', successRate: 87 },
    { condition: 'Arthritis', guarantee: 'Joint function improvement', timeframe: '25 days', measurement: 'Joint assessment + inflammation markers', successRate: 89 },
    { condition: 'Fertility Issues', guarantee: 'Conception support', timeframe: '180 days', measurement: 'Medical tests + monitoring', successRate: 88 }
  ];

  const certifications = [
    { name: 'ISO 9001:2015', description: 'Quality Management System', icon: Award },
    { name: 'NABH Accreditation', description: 'National Accreditation Board for Hospitals', icon: Shield },
    { name: 'Government Certified', description: 'Ministry of AYUSH certification', icon: CheckCircle },
    { name: 'WHO-GMP Compliance', description: 'Laboratory certification for medicine preparation', icon: Star }
  ];
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600">
                Get honest, detailed answers to all your questions about Ayurvedic treatment
              </p>
            </div>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          <div className={`w-12 h-12 bg-gradient-to-r ${faq.color} rounded-full flex items-center justify-center`}>
              ...
              <div className="min-w-full">
                ...
                <div className="space-y-2">
                  {guarantees.map((item, index) => (
                    <Card key={index} className="hover:shadow-md transition-shadow duration-300 rounded-none border-x border-b border-gray-200">
                      <CardContent className="p-4">
                        <div className="grid grid-cols-5 gap-4 items-center">
                          <div className="font-semibold text-gray-900">{item.condition}</div>
                          <div className="text-center text-green-600 font-medium">{item.guarantee}</div>
                          <div className="text-center">
                            <Badge className="bg-blue-100 text-blue-800">
                              {item.timeframe}
                            </Badge>
                          </div>
                          <div className="text-center text-gray-700 text-sm">{item.measurement}</div>
                          <div className="text-center">
                ...
                <CardContent className="p-8">
                  <div className="text-center">
                    ...
                    <p className="text-lg text-gray-700 mb-6">
                      "Feel 50% better after first session or receive additional support"
                    </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600">
                Our commitment to quality validated by leading healthcare authorities
              </p>
            </div>
            ...
            <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">Treatments with Zero Major Adverse Events</div>
              </div>
              <div className="text-center">
