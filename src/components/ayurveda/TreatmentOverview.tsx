                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-col gap-y-3">
                    <Link href={treatment.href} prefetch={false}>
                      <Button
                        className={`group/btn w-full bg-gradient-to-r ${treatment.color} hover:opacity-90 text-white group-hover:shadow-lg transition-all duration-300`}
                      >
                        {t("treatments.labels.learnMore")}
                        <ArrowRight className="size-4 ml-2 group-hover/btn:translate-x-1 transition-transform duration-300" />
                      </Button>
                    </Link>
                    <Button
                      variant="outline"
                      className="w-full !bg-white border-orange-500 text-orange-500 hover:!bg-orange-500 hover:text-white transition-all duration-300"
                    >
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-orange-500 to-red-600 rounded-2xl p-8 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-white text-orange-600 hover:bg-orange-600 hover:text-white border border-transparent hover:border-white transition-all duration-300 font-semibold shadow-md hover:shadow-lg"
              >
