...
const HealthAssessment = () => {
  ...
  const questions = [
    {
      ...
      type: 'body-map',
      options: ['Head/Neck', 'Shoulders', 'Back', 'Joints', 'Digestive', 'No Issues']
    },
    {
      id: 'energy',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      options: ['Strong & Regular', 'Variable', 'Weak', 'Irregular', 'Problematic']
    },
    {
      id: 'mental',
      title: 'Mental State',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      options: ['Pain Relief', 'Detoxification', 'Weight Management', 'Stress Relief', 'Overall Wellness']
    }
  ];
  ...
  const getResults = () => {
    ...
    const supportingTherapies = 'Agnikarma for joint pain, Viddha Karma for stress';
              ...
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Primary Dosha Constitution</h4>
                      <p className="text-orange-600 font-medium">{results.primaryDosha}</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Current Imbalance</h4>
                      <p className="text-gray-700">{results.imbalance}</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Recommended Primary Treatment</h4>
                      <p className="text-blue-600 font-medium">{results.treatment}</p>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Supporting Therapies</h4>
                      <p className="text-gray-700">{results.supportingTherapies}</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Expected Timeline</h4>
                      <p className="text-green-600 font-medium">{results.timeline} for significant transformation</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">Success Probability</h4>
                      <div className="flex items-center space-x-3">
                        <Progress value={results.successRate} className="flex-1" />
                        <span className="text-green-600 font-bold">{results.successRate}%</span>
                      </div>
                      <p className="text-sm text-gray-600 mt-1">Based on similar cases</p>
                    </div>
                  </div>
                </div>
            ...
            <CardContent>
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-2 text-sm text-gray-600">
                  ...
                  <span>~{questions.length - currentStep} minutes remaining</span>
                </div>
