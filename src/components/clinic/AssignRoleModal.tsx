            ...
            <div className="flex items-center gap-4">
              <div className={cn(
                ...
                <div className="flex items-center gap-2">
                  <div className={cn("size-2 rounded-full", isActive ? "bg-emerald-500" : "bg-red-500")} />
            ...
            <div className="gap-y-1">
              ...
              <div className="gap-y-1">
                ...
                >
                  ...
                  {activeTab === "role" && <ChevronRight className="size-4 ml-auto" />}
                </button>
                                      ...
                                      <div className="min-w-0">
                                        ...
                                        {!isDefault && isSelected && (
                                          <span className="text-[10px] font-bold text-amber-600 uppercase flex items-center gap-1">
                                            <Zap className="size-2.5 fill-amber-600" />
                                            Manual Override
                                          </span>
                                        )}
                                      </div>
