...
export function getVideoPaymentAmount(
  ...
  const candidateValues = [
    ...
    (appointment as any).payment?.totalAmount,
    (appointment as any).billing?.amount,
    (appointment as any).billing?.totalAmount,
    (appointment as any).billing?.total,
    (appointment as any).invoice?.amount,
    (appointment as any).invoice?.totalAmount,
    (appointment as any).invoice?.total,
    matchingService?.videoConsultationFee,
    matchingService?.consultationFee,
    matchingService?.amount,
    matchingService?.price,
    matchingService?.fee,
    matchingService?.totalAmount,
    ...
    (appointment as any).service?.totalAmount,
