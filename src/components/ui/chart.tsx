...
const ResponsiveContainer = dynamic(
  async () => {
    const { ResponsiveContainer: RechartsResponsiveContainer } = await import(
      "recharts"
    )

    return function ResponsiveContainerWrapper(
      props: React.ComponentProps<typeof RechartsResponsiveContainer>
    ) {
...
const ChartTooltip = dynamic(
  async () => {
    ...
    return function ChartTooltipWrapper(
...
const ChartLegend = dynamic(
  async () => {
    ...
    return function ChartLegendWrapper(
