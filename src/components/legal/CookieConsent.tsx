...
export function CookieConsent() {
  ...
  return (
    <section
      ...
      className="fixed inset-x-4 bottom-24 z-50 sm:inset-x-auto sm:left-6 sm:bottom-6 sm:w-[min(34rem,calc(100vw-9rem))]"
    >
      <div className="rounded-2xl border border-border bg-background/95 p-4 shadow-lg backdrop-blur supports-[backdrop-filter]:bg-background/85 sm:p-5">
