/**
 * ✅ Consolidated Pharmacy Store
 * Follows DRY, SOLID, KISS principles
 * Single source of truth for pharmacy state management
 * Uses types from @/types/pharmacy.types.ts
 */
...
// ✅ Consolidated: All types imported from @/types/pharmacy.types.ts (single source of truth)
...
interface PharmacyStore {
  ...
  filters: Partial<PharmacyFilters>; // ✅ Use Partial since all fields are optional
...
const defaultFilters: Partial<PharmacyFilters> = {
  search: '',
  category: '',
  manufacturer: '',
  stockStatus: 'all',
