...
export default function ContactPage() {
  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-linear-to-br from-background via-background to-muted/20 dark:from-background dark:via-background dark:to-muted/30 relative overflow-hidden">
        ...
        <section className="relative py-8 sm:py-12 md:py-16 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-linear-to-br from-primary/5 via-transparent to-secondary/5 dark:from-primary/10 dark:via-transparent dark:to-secondary/10"></div>
        ...
        <LazySection fallback={<SectionSkeleton />}>
          <section className="relative py-8 sm:py-12 md:py-16 bg-linear-to-br from-muted/30 via-background to-primary/5 dark:from-muted/40 dark:via-background dark:to-primary/10 overflow-hidden">
