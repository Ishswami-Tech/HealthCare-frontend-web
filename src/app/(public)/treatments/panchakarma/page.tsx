        ...
        <section className="relative py-8 sm:py-12 md:py-16 lg:py-20 overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-playfair font-semibold text-foreground mb-4 gradient-text leading-tight">
                {t("panchakarma.title")}
              </h1>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-playfair font-semibold text-foreground mb-4 gradient-text">
                  {t("panchakarma.whatIs.title")}
                </h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-12">
                <div>
                  <div className="relative">
                    ...
                    <div className="relative bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-2xl p-6 sm:p-8">
                      ...
                      <h3 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 gradient-text">
                ...
                <div className="gap-y-6">
                  <div className="flex items-start gap-x-4">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-foreground mb-2 gradient-text">
                    ...
                    >
                      <CardContent className="p-4 sm:p-6">
                        <div className="relative">
                          ...
                          <div className="absolute bottom-4 left-4 size-16 border border-secondary/20 rounded-full"></div>
                          <div
                            className={`size-12 sm:w-16 sm:h-16 bg-gradient-to-r ${benefit.color} rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 relative z-10`}
                          >
                            <IconComponent className="size-6 sm:w-8 sm:h-8 text-white" />
                          </div>
                        </div>
                        <h3 className="text-base sm:text-lg font-semibold text-foreground mb-2 sm:mb-3 gradient-text">
                          {benefit.title}
                        </h3>
                        <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                          {benefit.description}
                    ...
                    <CardContent className="p-0">
                      <div className="grid grid-cols-1 lg:grid-cols-4">
                        ...
                        >
                          ...
                          <div className="text-center lg:text-left relative z-10">
                            ...
                            <div className="size-16 sm:w-20 sm:h-20 bg-white/30 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto lg:mx-0 mb-4 shadow-lg">
                              <Droplets className="size-8 sm:w-10 sm:h-10 text-white drop-shadow-md" />
                            </div>
                            ...
                            <Badge className="bg-background/20 text-white border-white/30 text-xs sm:text-sm">
                              <Clock className="size-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
                              {phase.duration}
                            </Badge>
                          </div>
                        </div>
                        ...
                        <div className="lg:col-span-3 p-4 sm:p-6 flex flex-col justify-center">
                          <h4 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 gradient-text">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="gap-y-4">
                {[
                  ...
                  >
                    <CardContent className="p-4 sm:p-6">
                      <h3 className="text-base sm:text-lg font-semibold text-foreground mb-3 gradient-text">
                        {faq.question}
                      </h3>
                      <p className="text-muted-foreground leading-relaxed">
                        {faq.answer}
