    ...
    <PageTransition>
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 dark:from-background dark:via-background dark:to-muted/30 relative overflow-hidden">
        ...
        <div className="fixed inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-1/3 right-1/3 size-16 bg-gradient-to-r from-accent/20 to-accent/10 dark:from-accent/30 dark:to-accent/20 rounded-full animate-bounce-slow"></div>
