  ...
  const mainTreatments = [
    {
      ...
      description: '5000-year-old complete body-mind-soul purification system with five sacred procedures.',
      successRate: 95,
      duration: '21 days',
      sessions: '21-day program',
      conditions: ['Chronic Diseases', 'Digestive Disorders', 'Skin Conditions', 'Mental Health'],
    ...
    },
    {
      ...
      description: 'Precision fire therapy for instant pain relief using controlled micro-cauterization.',
      successRate: 92,
      duration: '2-3 weeks',
      sessions: '3-5 sessions',
      conditions: ['Chronic Knee Pain', 'Sciatica', 'Frozen Shoulder', 'Arthritis'],
    ...
    },
    {
      ...
      description: 'Strategic marma point stimulation using specialized instruments for complete healing.',
      successRate: 89,
      duration: '3-4 weeks',
      sessions: '4-6 sessions',
      conditions: ['Neurological Disorders', 'Joint Pain', 'Digestive Issues', 'Stress & Anxiety'],
  ...
  const specializedPrograms = [
    {
      ...
      description: 'Natural solutions for creating new life with comprehensive fertility services.',
      services: ['Male Fertility Enhancement', 'Female Fertility Optimization', 'PCOD/PCOS Treatment', 'IVF Support'],
      successRate: 88
    },
    {
      ...
      description: 'Executive health programs and workplace stress management solutions.',
      services: ['Executive Health Programs', 'Workplace Stress Management', 'Employee Wellness Days', 'Ergonomic Consultations'],
      successRate: 92
    },
    {
      ...
      description: 'Professional training programs to become certified Ayurvedic healers.',
      services: ['Certificate Courses', 'Diploma Programs', 'Advanced Specialization', 'International Certification'],
      successRate: 96
    },
    {
      ...
      icon: Heart,
      color: 'from-orange-500 to-red-600',
      description: 'Free healing services to humanity as our sacred duty to society.',
      services: ['Free Treatment Days', 'Rural Health Missions', 'Senior Citizen Care', 'Educational Workshops'],
      successRate: 100
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              Discover our complete range of authentic Ayurvedic treatments, each designed to 
              address specific health challenges with proven results and lasting transformation.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-12">
              {mainTreatments.map((treatment, index) => {
                ...
                return (
                  <Card key={treatment.id} className="bg-white shadow-xl border-0 overflow-hidden">
                    <CardContent className="p-0">
                      <div className={`grid lg:grid-cols-2 ${!isEven ? 'lg:grid-flow-col-dense' : ''}`}>
                        <div className={`bg-gradient-to-br ${treatment.bgColor} p-8 flex flex-col justify-center ${!isEven ? 'lg:col-start-2' : ''}`}>
                          <div className={`w-20 h-20 bg-gradient-to-r ${treatment.color} rounded-full flex items-center justify-center mb-6 ${isEven ? '' : 'ml-auto'}`}>
                            <IconComponent className="w-10 h-10 text-white" />
                          </div>
                          <div className="grid grid-cols-2 gap-4">
                            <div className="text-center">
                              <div className="text-2xl font-bold text-gray-900">{treatment.successRate}%</div>
                              <div className="text-sm text-gray-600">Success Rate</div>
                            </div>
                            <div className="text-center">
                              <div className="text-2xl font-bold text-gray-900">{treatment.sessions}</div>
                        ...
                        <div className={`p-8 flex flex-col justify-center ${!isEven ? 'lg:col-start-1' : ''}`}>
                          <h3 className="text-3xl font-playfair font-bold text-gray-900 mb-2">{treatment.title}</h3>
                          <p className="text-lg text-gray-600 mb-4">{treatment.subtitle}</p>
                          <p className="text-gray-700 mb-6 leading-relaxed">{treatment.description}</p>
                          
                          <div className="mb-6">
                            <h4 className="font-semibold text-gray-900 mb-3">Treats:</h4>
                            <div className="flex flex-wrap gap-2">
                              {treatment.conditions.map((condition, condIndex) => (
                                <Badge key={condIndex} variant="outline" className="text-gray-600">
                                  {condition}
                                </Badge>
                              ))}
                            </div>
                          ...
                          <div className="flex gap-4">
                            <Link href={treatment.href} className="flex-1">
                              <Button className={`w-full bg-gradient-to-r ${treatment.color} hover:opacity-90 text-white`}>
                                Learn More
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600">
                Most popular - 90% of patients choose these comprehensive programs
              </p>
            </div>
                ...
                <Card key={index} className="hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-white to-gray-50">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-2">Transformation Promise:</h4>
                        <p className="text-gray-700 font-medium">{pkg.promise}</p>
                      </div>

                      <div className="pt-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-sm font-medium text-gray-700">Popularity</span>
                          <span className="text-sm font-bold text-orange-600">{pkg.popularity}%</span>
                        </div>
                        <Progress value={pkg.popularity} className="h-2" />
                      </div>

                      <Button className={`w-full bg-gradient-to-r ${pkg.color} hover:opacity-90 text-white mt-6`}>
                        Choose This Package
                        <ArrowRight className="w-4 h-4 ml-2" />
                      </Button>
                    </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl text-orange-100 mb-8">
              Choose from our comprehensive range of treatments or let our experts 
              create a personalized healing plan just for you.
            </p>
