...
export default function TeamPage() {
  const chiefMedicalOfficers = [
    {
      name: 'Dr. Rajesh Vishwamurthi',
      title: 'MD (Ayurveda), Chief Medical Officer',
      specialization: 'Panchakarma Specialist',
      experience: '25+ years',
      image: '/api/placeholder/150/150',
      credentials: ['MD Ayurveda', 'Government Certified', 'Research Publications: 15+'],
      achievements: ['2000+ Panchakarma treatments', 'International speaker', 'Textbook author'],
    ...
    },
    {
      ...
      experience: '40+ years',
      image: '/api/placeholder/150/150',
      credentials: ['Traditional Gurukul Training', 'Sanskrit Scholar', 'Pulse Diagnosis Master'],
      achievements: ['5000+ patients treated', 'Ancient text interpreter', 'Spiritual healer'],
    ...
    },
    {
      ...
      experience: '20+ years',
      image: '/api/placeholder/150/150',
      credentials: ['BAMS Degree', 'Specialized Training', 'Pain Management Expert'],
      achievements: ['3000+ Agnikarma procedures', 'Zero complication record', 'Research pioneer'],
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              Our team combines 150+ years of collective experience, bringing together 
              traditional Ayurvedic wisdom and modern medical excellence for your complete healing.
            </p>
                ...
                <Card key={index} className="bg-white shadow-xl border-0 overflow-hidden">
                  <CardContent className="p-0">
                    <div className="grid md:grid-cols-3">
                      <div className={`bg-gradient-to-br ${doctor.color} text-white p-6 flex flex-col justify-center items-center`}>
                        <div className="w-24 h-24 bg-white/20 rounded-full flex items-center justify-center mb-4">
                          <User className="w-12 h-12 text-white" />
                        </div>
                        <div className="text-center">
                          <div className="text-lg font-bold mb-1">{doctor.experience}</div>
                          ...
                          <div>
                            ...
                            <ul className="space-y-1">
                              {doctor.credentials.map((credential, credIndex) => (
                                <li key={credIndex} className="flex items-center space-x-2">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600">
                Distinguished experts guiding our clinical excellence and research initiatives
              </p>
            </div>
                ...
                <Card key={index} className="hover:shadow-lg transition-shadow duration-300 border border-gray-100">
                  <CardHeader>
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <CardTitle className="text-lg text-gray-900">{advisor.name}</CardTitle>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Get personalized treatment recommendations from our world-class medical team. 
              Your healing journey begins with expert guidance.
            </p>
