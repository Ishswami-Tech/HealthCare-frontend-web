...
export default function EHRSystem() {
  ...
  return (
    <DashboardLayout title="Electronic Health Records" allowedRole={userRole}>
      <GlobalSidebar
        links={sidebarLinks}
        user={{
          name:
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="pt-4 border-t">
                        <p className="text-sm text-gray-600">
                          <strong>Last System Update:</strong> January 10, 2024
                        </p>
                        <p className="text-sm text-gray-600">
                          <strong>Data Integrity Check:</strong> Passed (January
                          15, 2024)
                        </p>
                      </div>
                    </div>
