      ...
      <Tabs defaultValue="plans" className="space-y-4">
        <div className="scrollbar-hide -mx-4 overflow-x-auto px-4 pb-2 sm:mx-0 sm:px-0">
          <TabsList className="inline-flex w-max min-w-full sm:flex sm:w-full">
            ...
            <TabsTrigger value="invoices" className="px-4 text-xs sm:text-sm">
              Invoices
            </TabsTrigger>
            <TabsTrigger value="payments" className="px-4 text-xs sm:text-sm">
              Payments
            </TabsTrigger>
            <TabsTrigger value="subscriptions" className="px-4 text-xs sm:text-sm">
              Subscriptions
            </TabsTrigger>
          </TabsList>
        </div>
                  ...
                  return (
                    <Card
                      ...
                      className={`overflow-hidden ${
                        isCurrentPlan ? "border-green-300 dark:border-green-900" : ""
                      }`}
                    >
                      ...
                      <CardContent className="p-4 sm:p-5 space-y-3">
                        ...
                        <div className="flex justify-stretch sm:justify-end pt-1">
                          {isCurrentPlan ? (
                            ...
                            <Button onClick={() => setPlanToConfirm(plan)} className="w-full sm:w-auto">
                              Subscribe & Pay
                            </Button>
                          )}
                        </div>
              ...
              {activeSubscriptions.length === 0 && endedSubscriptions.length > 0 && (
                <Card className="border-amber-200 bg-amber-50 dark:border-amber-900 dark:bg-amber-950/30">
                  <CardContent className="flex flex-col gap-3 py-5 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Button onClick={openPlansTab}>Purchase Again</Button>
                  </CardContent>
                </Card>
              )}
