...
export default function PatientMedicalRecords() {
  ...
  const medicalHistory = [
    {
      ...
      notes: "Patient shows signs of elevated Vata dosha. Recommended lifestyle changes and Shirodhara sessions.",
      status: "Completed"
    },
    {
      id: "2",
      ...
      notes: "Patient responded well to therapy. Improved sleep quality reported.",
      status: "Completed"
    },
    {
      id: "3",
      ...
      notes: "Initial assessment reveals strong Vata tendencies with Pitta secondary. Recommended cooling foods.",
      status: "Completed"
    }
  ];
  ...
  const prescriptions = [
    {
      ...
      doctor: "Dr. Priya Sharma",
      medications: [
        { name: "Triphala Churna", dosage: "1 tsp twice daily with warm water", duration: "30 days" },
        { name: "Ashwagandha Capsules", dosage: "2 capsules at bedtime", duration: "60 days" },
        { name: "Brahmi Ghrita", dosage: "5 drops in each nostril morning", duration: "21 days" }
      ],
      instructions: "Take medicines 30 minutes before meals. Avoid cold foods and drinks.",
      status: "Active"
    },
    {
      id: "2",
      ...
      doctor: "Dr. Priya Sharma",
      medications: [
        { name: "Saraswatarishta", dosage: "15ml twice daily after meals", duration: "45 days" },
        { name: "Jatamansi Churna", dosage: "1/2 tsp with honey at bedtime", duration: "30 days" }
      ],
      instructions: "Continue meditation and yoga practice. Follow prescribed sleep schedule.",
      status: "Completed"
    }
  ];
  ...
  const labReports = [
    {
      ...
      results: [
        { parameter: "Hemoglobin", value: "13.2 g/dl", normalRange: "12.0-16.0", status: "Normal" },
        { parameter: "WBC Count", value: "7,200 cells/mcL", normalRange: "4,000-11,000", status: "Normal" },
        { parameter: "Platelet Count", value: "2.8 lakhs/mcL", normalRange: "1.5-4.5 lakhs", status: "Normal" }
      ],
      doctor: "Dr. Priya Sharma",
      status: "Normal"
    },
    {
      ...
      results: [
        { parameter: "Total Cholesterol", value: "195 mg/dl", normalRange: "<200", status: "Normal" },
        { parameter: "LDL", value: "125 mg/dl", normalRange: "<100", status: "High" },
        { parameter: "HDL", value: "48 mg/dl", normalRange: ">40", status: "Normal" },
  ...
  const vitalSigns = [
    { date: "2024-01-15", bp: "128/82", hr: "72", temp: "98.6", weight: "70", height: "175", bmi: "22.9" },
    { date: "2024-01-08", bp: "132/85", hr: "75", temp: "98.4", weight: "70.5", height: "175", bmi: "23.0" },
    { date: "2024-01-01", bp: "135/88", hr: "78", temp: "98.8", weight: "71", height: "175", bmi: "23.2" },
    { date: "2023-12-20", bp: "138/90", hr: "80", temp: "98.6", weight: "71.5", height: "175", bmi: "23.3" }
  ];

  const allergies = [
    { allergen: "Tree Nuts", severity: "Moderate", reaction: "Skin rash, itching", discovered: "2020-03-15" },
    { allergen: "Shellfish", severity: "Mild", reaction: "Digestive discomfort", discovered: "2019-08-22" },
    { allergen: "Dust Mites", severity: "Mild", reaction: "Respiratory symptoms", discovered: "2018-11-10" }
  ];
                              ...
                              {report.results.map((result, index) => (
                                <div key={index} className="p-3 border rounded-lg">
                                  <div className="flex items-center justify-between mb-1">
                                    <span className="font-medium text-sm">{result.parameter}</span>
                            ...
                            <tbody>
                              {vitalSigns.map((vital, index) => (
                                <tr key={vital.date} className="border-t">
                                  <td className="px-4 py-2">{new Date(vital.date).toLocaleDateString()}</td>
                      ...
                      {allergies.map((allergy, index) => (
                        <div key={index} className="p-4 border rounded-lg bg-red-50 border-red-200">
                          ...
                          <p className="text-xs text-red-600">
                            Discovered: {new Date(allergy.discovered).toLocaleDateString()}
                          </p>
                        </div>
                      ))}
                      ...
                      <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                        <div className="flex items-start gap-2">
                          ...
                          <div className="text-sm text-yellow-800">
                            ...
                            <p>Always inform your healthcare providers about these allergies before any treatment or prescription.</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <CardContent>
                    <div className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                          <div className="p-4 bg-green-50 rounded-lg">
                            <h3 className="font-semibold text-green-800 mb-2">Dietary Type</h3>
                            <p className="text-green-700">{dietaryPreferences.type}</p>
                          </div>

                          <div className="p-4 bg-blue-50 rounded-lg">
                            <h3 className="font-semibold text-blue-800 mb-2">Constitutional Guidance</h3>
                            <p className="text-blue-700">{dietaryPreferences.constitution}</p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-4">
                          <div className="p-4 bg-red-50 rounded-lg">
                            ...
                            <div className="space-y-1">
                              {dietaryPreferences.restrictions.map((restriction, index) => (
                                <div key={index} className="flex items-center gap-2">
                                  <AlertTriangle className="w-3 h-3 text-red-600" />
                                  <span className="text-red-700 text-sm">{restriction}</span>
                                </div>
                              ))}
                            </div>
                          </div>
                          ...
                          <div className="p-4 bg-emerald-50 rounded-lg">
                            ...
                            <div className="space-y-1">
                              {dietaryPreferences.preferences.map((preference, index) => (
                                <div key={index} className="flex items-center gap-2">
                                  <CheckCircle className="w-3 h-3 text-emerald-600" />
                                  <span className="text-emerald-700 text-sm">{preference}</span>
                                </div>
                              ))}
                            </div>
                          </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="p-4 bg-gradient-to-br from-orange-50 to-yellow-50 rounded-lg">
                          <h4 className="font-semibold text-orange-800 mb-2">Morning Routine</h4>
                        ...
                        <div className="p-4 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg">
                          <h4 className="font-semibold text-blue-800 mb-2">Meal Guidelines</h4>
