    ...
    <Card className="overflow-hidden border shadow-sm">
      <CardContent className="p-2.5 sm:p-3">
        ...
        <div className="mt-2.5 grid grid-cols-1 gap-2 sm:grid-cols-2 xl:grid-cols-6">
          ...
          <DashboardMetricCard
            label="In-person"
            value={stats.inPersonToday}
            subtext="Visits"
            accentClassName="border-amber-200 bg-amber-50 dark:border-amber-500/20 dark:bg-amber-500/10"
            valueClassName="mt-1 text-lg font-bold leading-none text-amber-900 dark:text-amber-100"
            labelClassName="text-amber-700 dark:text-amber-300"
            compact
          />
          <DashboardMetricCard
            label="Live queue"
            value={stats.liveQueueCount}
            subtext="Patients"
            accentClassName="border-cyan-200 bg-cyan-50 dark:border-cyan-500/20 dark:bg-cyan-500/10"
            valueClassName="mt-1 text-lg font-bold leading-none text-cyan-900 dark:text-cyan-100"
