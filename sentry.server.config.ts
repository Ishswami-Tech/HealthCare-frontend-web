...
const PHI_KEYS = new Set([
  ...
  "ssn",
  "nationalId",
  "userId", // maps to real identity in this app
  "patientId",
  "doctorId",
]);

/**
 * Recursively sanitize an object by redacting PHI keys and matching PHI string values.
 */
...
function sanitizeEvent(event: Sentry.Event): void {
  if (event.user) {
    // Keep only the internal ID, strip any PII
...
/**
 * Scrub a single string for PHI patterns.
 */
